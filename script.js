/*==================================
مجمع حمزه الشطري
Professional Store JS Firebase
==================================*/
...
onclick="addToCart('${(p.name||"").replace(/'/g,"\\'")}',${Number(p.price||0)},'${p.image||""}')">
...
onclick="addToFavorites('${(p.name||"").replace(/'/g,"\\'")}',${Number(p.price||0)},'${p.image||""}')">
...
"https://wa.me/9647813555538?text="+text,
